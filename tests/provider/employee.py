...
class EmployeeServiceContract(unittest.TestCase):

    def test_employee_service_contract_get(self):
        # Define the consumer and provider
        consumer = Consumer('EmployeeService')
    ...
    def test_employee_service_contract_post(self):
        # Define the consumer and provider
        consumer = Consumer('EmployeeService')
        provider = Provider('EmployeeService', host_url='http://employee-service-api')
    ...
    def test_employee_service_contract_put(self):
        # Define the consumer and provider
        consumer = Consumer('EmployeeService')
        provider = Provider('EmployeeService', host_url='http://employee-service-api')
